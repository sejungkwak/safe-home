...
CREATE POLICY "Anyone can update their own photo." ON "storage"."objects" FOR UPDATE USING ((( SELECT "auth"."uid"() AS "uid") = "owner")) WITH CHECK (("bucket_id" = 'files'::"text"));



CREATE POLICY "Profile photo is publicly accessible." ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'profiles'::"text"));



CREATE POLICY "Users can delete their own driving licence photo." ON "storage"."objects" FOR DELETE USING ((("bucket_id" = 'licences'::"text") AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "Users can delete their own profile photo." ON "storage"."objects" FOR DELETE USING ((("bucket_id" = 'profiles'::"text") AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "Users can update their own driving licence photo." ON "storage"."objects" FOR UPDATE USING ((("bucket_id" = 'licences'::"text") AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "Users can update their own profile photo." ON "storage"."objects" FOR UPDATE USING ((("bucket_id" = 'profiles'::"text") AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "Users can upload their own driving licence photo." ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'licences'::"text") AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "Users can upload their own profile photo." ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'profiles'::"text") AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "Users can view their own driving licence photo." ON "storage"."objects" FOR SELECT USING ((("bucket_id" = 'licences'::"text") AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));
